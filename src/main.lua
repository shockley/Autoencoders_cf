...
cmd:option('-conf'           , "../conf/conf.movieLens.1M.V.lua" , 'The relative path to the lua configuration file')
...
cmd:option('-gpu'            , 0                                  , 'use gpu. CPU = 0, GPU > 0 with GPU the index of the device')
